...
describe OrderRefundsController do
  ...
  describe "POST submit" do
    ...
    let(:refund) { build :course_order_refund, order: order }
    it "should be success" do
      post :submit, course_id: course.id, id: order.id, refund: { amount: refund.amount, reason: refund.reason }, format: 'json'
