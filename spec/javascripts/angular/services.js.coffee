describe "participants", ->
  participants = null
  beforeEach ->
    module 'shinebox' # fixed jasmine: Error: Unknown provider: participantsProvider <- participants
    inject ($rootScope, $injector, $http) ->
      ...
      $httpBackend.when('GET', '/api/courses/1/participants').respond(200, data)
